...
cat wp-subdomains.txt  | while true ; do read url; if [ "" = "$url" ] ; then break; fi ; wpscan  --url $url --wp-content-dir wp-content --disable-tls-checks --api-token [wpscan-api]  --force ; done >>wpscan-out.txt
